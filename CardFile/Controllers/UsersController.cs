...
namespace CardFile.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "UserId,FullName,Birthday,HomeAddress,HomePhone")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "UserId,FullName,Birthday,HomeAddress,HomePhone")] User user)
        {
            if (ModelState.IsValid)
            {
